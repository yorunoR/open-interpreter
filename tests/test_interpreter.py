...
def test_hello_world():
    ...
    assert messages == [
        {"role": "user", "content": 'Please reply with just the words "Hello, World!" and nothing else. Do not run code.'},
...
def test_math():
    ...
    messages = interpreter.chat(
        """Please perform the calculation 27073*7397 then reply with just the integer answer with no commas or anything, nothing else.""", return_messages=True
    )
